...
class TcpServerFluxerTest {
	...
	void test() throws Exception {
		...
		// fail("Shouldn't throw an error");
		// }).doOnNext(message -> {
		// System.out.println("subscriber 1 | Server log received: " + message);
		// }).doOnComplete(new Runnable() {
		// @Override
		// public void run() {
		// System.out.println(
		// "subscriber 1 | Server log completed");
		// }
		// }).subscribe();
		...
		tcpClient.start().doOnError(err -> {
			...
			System.out.println(System.currentTimeMillis() + ":client failed to start at "
					+ portNumber);
		}).doOnSuccess(result -> {
			countDownLatch2.countDown();
			System.out.println(System.currentTimeMillis() + ":" + result);
			System.out.println("Client starting took " + (System.currentTimeMillis() -
					now2));
		}).subscribe();
		try {
		...
		tcpClient.stop().doOnError(err -> {
			...
			System.out.println("Client stopping took " + (System.currentTimeMillis() -
					now4));
		}).subscribe();
		try {
		...
		tcpClient.start().doOnError(err -> {
			...
			System.out.println("Client starting again took " +
					(System.currentTimeMillis() - now5));
		}).subscribe();
		try {
		...
		// @Override
		// public void run() {
		// System.out.println("Server link completed and total " + serverLink.size() + "
		// received");
		// }
		// }).subscribe();
		//
		...
		// @Override
		// public void run() {
		// System.out.println("Server status completed and total " + serverStatus.size()
		// + " received");
		// }
		// }).subscribe();
		//
		...
		// @Override
		// public void run() {
		// System.out.println("subscriber 1 | Server message completed and total " +
		// serverInbound.size() + " received");
		// }
		// }).subscribe();
		//
		// tcpServer.read().doOnError(error -> {
		...
		// @Override
		// public void run() {
		// System.out.println("subscriber 2 | Server message completed and total " +
		// serverInbound.size() + " received");
		// }
		// }).subscribe();
		//
		...
		// @Override
		// public void run() {
		// System.out.println("Client link completed and total " + clientLink.size() + "
		// received");
		// }
		// }).subscribe();
		//
		...
		// @Override
		// public void run() {
		// System.out.println("Client status completed and total " + clientStatus.size()
		// + " received");
		// }
		// }).subscribe();
		//
		...
		// @Override
		// public void run() {
		// System.out.println("Client message completed and total " +
		// clientInbound.size() + " received");
		// }
		// }).subscribe();
		...
		// tcpServer.write(new Message(serverLink.get(0),
		// "1234".getBytes())).doOnError(error -> {
		...
		// final CountDownLatch countDownLatch3 = new CountDownLatch(1);
		// tcpClient.write(new Message(clientLink.get(0),
		// "1234".getBytes())).doOnError(error -> {
		// countDownLatch3.countDown();
		...
		// // Sleep for a few msec(1 msec doesn't work?) to make sure they are published
		// separately
		// try {
		// Thread.sleep(2L);
		// } catch (InterruptedException e) {
